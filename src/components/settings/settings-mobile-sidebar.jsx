...
function SettingsMobileSidebar({ config }) {
        ...
        <DropdownMenuTrigger className="mt-auto" asChild>
          ...
          >
            ...
            <div className="text-left leading-tight">
              <p className="turncate text-sm text-semibold">
                {session?.user.name}
              </p>
  ...
  return (
    <Sheet open={isOpen} onOpenChange={() => setOpen(!isOpen)}>
      <SheetContent side="left" className="flex h-full flex-col space-y-3">
        ...
        <div className="flex flex-col h-full space-y-3">
          <Button
            variant="sidebar"
            className={cn(
              currentPath === "/settings" && "bg-secondary shadow-sm",
            )}
            onClick={() => {
          ...
          <div className="space-y-2">
            <p className="text-sm font-medium text-muted-foreground px-4 truncate">
              Account
            </p>
            <Button
              variant="sidebar"
              className={cn(
                currentPath === "/settings/profile" && "bg-secondary shadow-sm",
              )}
              onClick={() => {
            ...
            <Button
              variant="sidebar"
              className={cn(
                currentPath === "/settings/account" && "bg-secondary shadow-sm",
              )}
              onClick={() => {
            ...
            <Button
              variant="sidebar"
              className={cn(
                currentPath === "/settings/privacy" && "bg-secondary shadow-sm",
              )}
              onClick={() => {
          ...
          <div className="space-y-2">
            ...
            <Button
              variant="sidebar"
              className={cn(
                currentPath === "/settings/data/export" &&
            ...
            <Button
              variant="sidebar"
              className={cn(
                currentPath === "/settings/data/import" &&
                  "bg-secondary shadow-sm",
              )}
              onClick={() => {
