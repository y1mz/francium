      ...
      <div className="mx-auto text-center">
        <div className="flex gap-3 justify-center items-center">
          ...
          <Tooltip>
            ...
            <TooltipContent>Check Urls</TooltipContent>
          </Tooltip>
          <Tooltip>
            <TooltipTrigger asChild>
              <Link href="https://github.com/B4tuhanY1lmaz/francium">
          ...
          <Tooltip>
            <TooltipTrigger>
              <p className="font-bold text-sm text-black/60 dark:text-white/40 hover:underline">
                {jsonContent.version}
              </p>
            </TooltipTrigger>
            <TooltipContent>
